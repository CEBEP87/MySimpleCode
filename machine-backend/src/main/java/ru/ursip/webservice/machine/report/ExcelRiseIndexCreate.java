    ...
    public static Workbook createNewExcelDocument(Period period,Period previousPeriod) throws IOException {
        ...
        if (settings.getTableHeadColumns() != null) {
            ...
            for (Resource resourcePeriod : period.getResource()) {
                ...
                for(Resource res:previousPeriod.getResource())
                {
...
//        Row headRow = sheet.createRow(endRow);
     ...
     */
    private static Row createTableRow(int rowNum, Resource currentResourcePeriod, int countResourcePeriod, Resource previousResource) {
