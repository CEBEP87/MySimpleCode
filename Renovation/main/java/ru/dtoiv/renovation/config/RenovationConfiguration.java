...
@Slf4j
@EnableJpaRepositories("ru.XXXXXXXXX.renovation.repository")
@EnableTransactionManagement
@ComponentScan(value = "ru.XXXXXXXXX.renovation.*")
@Configuration
@EnableWebMvc
@EnableSwagger2
public class RenovationConfiguration extends WebMvcConfigurerAdapter {
